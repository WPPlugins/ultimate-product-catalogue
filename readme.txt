...
<strong>Now with full WooCommerce Integration!</strong> See the "WooCommerce Catalog Integration" section below for full details and features.
...
= WooCommerce Catalog Integration (premium) =
...
* Quickly create your catalog in the admin with options to add individual products or whole categories to your product.
* Drag and drop catalog items in the admin to choose your product catalog's starting order. There is also the ability to sort catalog items, as well as products within a category, alphabetically.
...
* Multiple product page types, including the ultra-responsive tabbed product page layout
* Add new tabs to your product page and choose the starting tab
* 3 extra product catalog styles: minimalist, block and hover styles, with more to come!
* Custom fields that can be added to your product catalog and as a product filer, which can be used to include product manuals, additional information, etc., and for product catalog filtering
* Choose between checkbox, radio button, dropdown and slider for the front-end product filter control type for your custom field
* Choose between checkbox, radio button and dropdown for the front-end product filter control type for your product categories, product sub-categories and product tags
* Product inquiry form, with the ability to have the product name and, if desired, the product ID as automatically-populated fields
...
* Lightbox option for clean and modern display of images on the product page
...
9. View of the sidebar product filters showing the different control types
10. Catalog with product comparison enabled and a category image in the sidebar
11. View of the product comparison page
12. Catalog with hierchical sub-categories
13. View of the catalog "Product Inquiry Form" (requires Contact Form 7 plugin)
14. View of the "Custom Product Page" catalog product page type
15. View of catalog page with Lightbox Mode enabled
16. View of the catalog with a product on sale
17. Sale price on the product page
18. Display reviews on the product page with <a href="http://wordpress.org/plugins/ultimate-reviews/">Ultimate Reviews</a>
19. View of the Catalog Overview Mode
20. View of the product catalog admin "Dashboard" tab
21. View of the "Products" tab
22. View of the "Catalogues" tab
23. View of the catalog edit tab
24. View of the "Categories" tab
25. View of the "Custom Fields" tab
26. View of the custom product page layout builder
27. View of the basic catalog options
28. View of the premium catalog options
29. View of the WooCommerce product catalog integration options
30. View of the product catalog SEO options
31. View of the product catalog labelling options
